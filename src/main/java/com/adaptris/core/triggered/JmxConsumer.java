 ...
 *
 * <p>
 * The unique-id is used as part of the {@link ObjectName}
 * </p>
 *
...
public class JmxConsumer extends AdaptrisMessageConsumerImp implements LicensedComponent {
  ...
  public void prepare() throws CoreException {
    if (getUniqueId() == null) {
      throw new IllegalArgumentException("This triggered-jmx-consumer must have a unique-id configured to work");
    }
  ...
  private String getJmxUid() {
    return DestinationHelper.consumeDestination(getUniqueId());
  }
  ...
  protected String newThreadName() {
    return DestinationHelper.threadName(retrieveAdaptrisMessageListener(), getUniqueId());
  }
}
